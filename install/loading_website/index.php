...
<head>
    ...
    <title>Installing Anicah's Kitchen Online Food Ordering System</title>
...
<body>
    <div class="install search-wrapper">
        <p align="middle" class="img-header"><img src="../logo.png" align="center" style="width:150px">
        <div class="tag">Installation in Progress</div>
        </p>
		...
		<p>/The website will be ready in next <span id="counter">30</span> seconds</p>
	</code>
