        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="login-block">
                    ...
                    <div class="login-block-header text-center"><?php echo get_languageword('login');?></div>
                    ...
                    <div class="form-group">
                        <button type="submit" name="login"
                            class="btn btn-primary btn-block "><b><?php echo get_languageword('login');?></b></button>
                    </div>

                    <div class="form-group">

                        <a href="#" onclick="show_popup('<?php echo $signup_modal;?>')"
                            class="sing-link"><?php echo get_languageword('sign_up');?></a>
                        <a href="#" onclick="show_popup('<?php echo $forgot_modal;?>')"
                            class="forgot-password-link "><?php echo get_languageword('forgot_password?');?></a>
                    </div>
                    ...
                    <div class="login-with-social">
                        ...
                        <a href="<?php echo $aauthUrl;?>"><img src="<?php echo FRONT_IMAGES;?>sign-g.svg"
                                alt="Login through Google" class="sc-icn"></a>

                        <a href="<?php echo $authUrl;?>"><img src="<?php echo FRONT_IMAGES;?>sign-f.svg"
                                alt="Login through Facebook" class="sc-icn"></a>
    ...
    <div class="modal-dialog ">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="login-block">
                    <button type="button" class="close modal-close" data-dismiss="modal">&times;</button>
                    <div class="login-block-header text-center"><img src="<?php echo FRONT_IMAGES;?>food.svg"
                            alt="Register" class="d-icon"><?php echo get_languageword('register');?></div>
                    ...
                    <div class="form-group">
                        <button type="submit" name="register"
                            class="btn btn-primary btn-block "><b><?php echo get_languageword('register');?></b></button>
                    </div>

                    <div class="form-group">

                        <a href="#" onclick="show_popup('<?php echo $lgin_modal;?>')"
                            class="sing-link"><?php echo get_languageword('login');?></a>
                        <a href="<?php echo URL_TERMS_CONDITIONS;?>"
                            class="forgot-password-link"><?php echo get_languageword('terms_conditions');?></a>
                    </div>
                    ...
                    <div class="login-with-social">
                        ...
                        <a href="<?php echo $aauthUrl;?>"><img src="<?php echo FRONT_IMAGES;?>sign-g.svg" alt=""
                                class="sc-icn"></a>

                        <a href="<?php echo $authUrl;?>"><img src="<?php echo FRONT_IMAGES;?>sign-f.svg" alt=""
                                class="sc-icn"></a>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="login-block">
                    <button type="button" class="close modal-close" data-dismiss="modal">&times;</button>
                    <div class="login-block-header text-center"><img src="<?php echo FRONT_IMAGES;?>food.svg"
                            alt="Forgot Password" class="d-icon"><?php echo get_languageword('forgot_password?');?>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" name="forgot_pwd"
                            class="btn btn-primary btn-block "><b><?php echo get_languageword('submit');?></b></button>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <a href="#" onclick="show_popup('<?php echo $lgin_modal;?>')"
                            class="forgot-password-link"><?php echo get_languageword('login');?></a>
                    ...
                    <div class="login-with-social">
                        <span><?php echo get_languageword('or_login_through');?></span> <a href="#"><img
                                src="<?php echo FRONT_IMAGES;?>sign-g.svg" alt="" class="sc-icn"></a><a href="#"><img
                                src="<?php echo FRONT_IMAGES;?>sign-f.svg" alt="" class="sc-icn"></a>
                    </div>
                </div>
            </div>
        </div>
				 ...
				 echo form_open(URL_CART_ADD_ADDRESS,$attributes);?>
                    ...
                    <div class="form-group">
                        <button type="submit" name="address"
                            class="btn btn-primary btn-block "><b><?php echo get_languageword('add');?></b></button>
                    </div>
...
function get_adns_options(item_id) {
    ...
    if (item_id > 0) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: '<?php echo $this->security->get_csrf_token_name();?>=<?php echo $this->security->get_csrf_hash();?>&item_id=' +
                item_id,
...
function get_offer_popup(offer_id, frm = '') {
    ...
    if (offer_id > 0) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: '<?php echo $this->security->get_csrf_token_name();?>=<?php echo $this->security->get_csrf_hash();?>&offer_id=' +
                offer_id + '&frm=' + frm,
            success: function(response) {
...
function load_cart_summary_div() {
    ...
    $("#cart-div").html(
        '<div class="loader-pad"><img class="abs-loader" src="<?php echo LOADER_IMG;?>" alt="Loader" align="middle"></div>'
    );
...
function check_address(ua_id) {
    ...
    if (ua_id > 0) {
        ...
        $.ajax({
            url: '<?php echo base_url();?>welcome/load_cart_summary_div',
            type: 'POST',
            data: '<?php echo $this->security->get_csrf_token_name();?>=<?php echo $this->security->get_csrf_hash();?>&ua_id=' +
                ua_id + '&discount=' + discount + '&checked=' + checked,
            success: function(response) {
...
function check_points() {
    ...
    $.ajax({
        url: '<?php echo base_url();?>welcome/load_cart_summary_div',
        type: 'POST',
        data: '<?php echo $this->security->get_csrf_token_name();?>=<?php echo $this->security->get_csrf_hash();?>&discount=' +
            discount + '&checked=' + checked + '&ua_id=' + ua_id,
        success: function(response) {
...
function get_localities() {
    ...
    if (city_id > 0) {
        ...
        $.ajax({
            ...
            data: '<?php echo $this->security->get_csrf_token_name();?>=<?php echo $this->security->get_csrf_hash();?>&city_id=' +
                city_id,
