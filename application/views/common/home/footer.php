     ...
     <div class="container">
         <div class="row">
             <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                 ...
                 <img class="img-responsive footer-logo" src="<?php echo get_second_site_logo();?>" alt="">
                 <p class="footer-text">
                     <?php echo get_languageword('Home of the Freshly Baked Pili Roll ~ HOME-BASED CUISINE');?></p>

                 <div class="ct-social">
                     <?php if(isset($this->config->item('social_networks')->facebook) && $this->config->item('social_networks')->facebook != '') { ?>
                     <a href="<?php echo $this->config->item('social_networks')->facebook;?>" target="_blank"><i
                             class="fa fa-facebook" aria-hidden="true"></i></a>
                     <?php } if(isset($this->config->item('social_networks')->twitter) && $this->config->item('social_networks')->twitter != '') { ?>
                     <a href="<?php echo $this->config->item('social_networks')->twitter;?>" target="_blank"><i
                             class="fa fa-twitter" aria-hidden="true"></i></a>
                     <?php } if(isset($this->config->item('social_networks')->instagram) && $this->config->item('social_networks')->instagram != '') {?>
                     <a href="<?php echo $this->config->item('social_networks')->instagram;?>" target="_blank"><i
             ...
             <div class="col-lg-<?php echo $clg; ?> col-md-<?php echo $clg; ?> col-sm-6 col-xs-6">
                ...
                ?>
                 ...
                 <ul class="cs-footer-links">
                     ...
                     <li><a
                             href="<?php echo URL_TERMS_CONDITIONS;?>"><?php echo get_languageword('terms_conditions');?></a>
                     </li>
                 ...
                 <div class="media cs-media">
                     ...
                     <div class="media-body ct-media-bodys">
                         ...
                         <p> <i class="fa fa-clock-o" aria-hidden="true"></i>
                             <?php if(isset($this->config->item('site_settings')->from_time)) echo $this->config->item('site_settings')->from_time;?>
                             -
                             <?php if(isset($this->config->item('site_settings')->to_time)) echo $this->config->item('site_settings')->to_time;?>
                         </p>
                     </div>
                 </div>
                 <div class="media cs-media">
                     ...
                     <div class="media-body ct-media-bodys">
                         ...
                         <p><?php if(isset($this->config->item('site_settings')->land_line)) echo $this->config->item('site_settings')->land_line;?>
                         </p>
                     </div>
                 </div>
