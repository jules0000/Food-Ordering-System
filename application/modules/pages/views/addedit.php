              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_PAGES_INDEX; ?>"><i class="fa fa-list"></i>
                      </a>
                  </div>
                  <div class="panel-body">
                      ...
                      <div class="row">
						...
						echo form_hidden('id',$value);?>
                                  ...
                                  <button type="submit" name="addedit_page" value="addedit_page"
                                      class="btn btn-primary"><?php echo get_languageword('save');?></button>

                                  <a class="btn btn-warning"
                                      href="<?php echo URL_PAGES_INDEX;?>"><?php echo get_languageword('cancel');?></a>
                              </div>
