  <div id="page-wrapper">
	...
	if (!empty($pagetitle)) echo $pagetitle; ?>
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_LANGUAGE_PHRASES; ?>"><i class="fa fa-list"></i></a>
...
echo form_open(URL_LANGUAGE_ADDEDIT_PHRASE, $attributes);?>
					...
					echo form_input($element) . form_error('lang_key');?>
                              </div>
...
if (!empty($details))
	...
	if (!empty($record))
	{
		echo form_hidden('id', $record->lang_id);
                                  ...
                                  <button type="submit" name="addedit_phrase" value="addedit_phrase"
