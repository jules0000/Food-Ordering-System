...
<!-- Form Validation Plugins /Start --><?php
...
$(document).ready(function() {
            $('#language_form')
                .bootstrapValidator({ // To use feedback icons, ensure that you use Bootstrap v3.1.0 or later            /* feedbackIcons: {                valid: 'glyphicon glyphicon-ok',                invalid: 'glyphicon glyphicon-remove',                validating: 'glyphicon glyphicon-refresh'            }, */            framework: 'bootstrap',            excluded: ':disabled',            fields: {                title: {                    validators: {                        notEmpty: {                            message: '<?php
