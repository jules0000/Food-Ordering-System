<div id="page-wrapper">
    <div class="row">
        <div class="col-md-12">
            ...
            <a title="<?php echo get_languageword('Add_New_Record'); ?>" class="btn btn-primary btn-xs pull-right"
                href="<?php echo URL_LANGUAGE_ADDEDIT_PHRASE; ?>"><i class="fa fa-plus"></i> </a>
                        ...
                        <table id="example" class="display responsive nowrap" width="100%" cellspacing="0"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="min-width:80px !important;"><?php echo get_languageword('actions'); ?>
                                    </th>
                                </tr>
                            </thead>
