        ...
        <div class="row">
            ...
            <div class="col-md-4 col-lg-3">
                <a href="<?php echo URL_ITEMS_INDEX;?>" title="<?php echo get_languageword('items');?>">
                    <div class="media stats-media-white bg-white">
                        <div class="media-left">
                            <img src="<?php echo FRONT_IMAGES;?>dashboard-fast-food.svg" width="50" height="50"
                                alt="Items">
                        </div>
                        <div class="media-body text-right">
            ...
            <div class="col-md-4 col-lg-3">
                <a href="<?php echo URL_ADDONS_INDEX;?>" title="<?php echo get_languageword('addons');?>">
                    <div class="media stats-media-white bg-white">
                        <div class="media-left">
                            <img src="<?php echo FRONT_IMAGES;?>dashboard-condiment.svg" width="40" height="40"
                                alt="Addons">
                        </div>
                        <div class="media-body text-right">
            ...
            <div class="col-md-4 col-lg-3">
                <a href="<?php echo URL_OFFERS_INDEX;?>" title="<?php echo get_languageword('offers');?>">
                    <div class="media stats-media-white bg-white">
                        <div class="media-left">
                            <img src="<?php echo FRONT_IMAGES;?>dashbaoard-voucher.svg" width="50" height="50"
                                alt="Offers">
                        </div>
                        <div class="media-body text-right">
            ...
            <div class="col-md-4 col-lg-3">
                <a href="<?php echo URL_CUSTOMERS_INDEX;?>" title="<?php echo get_languageword('customers');?>">
                    <div class="media stats-media-white bg-white">
                        <div class="media-left">
                            <img src="<?php echo FRONT_IMAGES;?>dashboard-network.svg" width="50" height="50"
                                alt="Customers">
                        </div>
                        <div class="media-body text-right">
...
<!--/.PAGE WRAPPER-->
<!--
<a href="<?php echo SITEURL;?>document" target="_blank"
    class="documentation-btn"><?php echo get_languageword('documentation');?></a>
<style type="text/css">
.documentation-btn {
    position: fixed;
    ...
    $.ajax({
        ...
        success: function(data1) {
            ...
            data.addColumn('number', 'Amount (' +
                '<?php echo $this->config->item('site_settings')->currency_symbol;?>' + ')');
