              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_OPTIONS_INDEX; ?>"><i class="fa fa-list"></i>
                      </a>
                  </div>
                  <div class="panel-body">
                      ...
                      <div class="row">
						...
						echo form_hidden('option_id',$value);?>
                                  ...
                                  <button type="submit" name="addedit_option" value="addedit_option"
                                      class="btn btn-primary"><?php echo get_languageword('save');?></button>

                                  <a class="btn btn-warning"
                                      href="<?php echo URL_OPTIONS_INDEX;?>"><?php echo get_languageword('cancel');?></a>
                              </div>
