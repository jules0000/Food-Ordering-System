              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_FAQS_CATEGORIES_INDEX; ?>"><i class="fa fa-list"></i>
                  ...
                  <div class="panel-body">
                      ...
                      <div class="row">
						...
						echo form_hidden('fc_id',$value);?>
                                  ...
                                  <button type="submit" name="addedit_fc" value="addedit_fc"
                                      class="btn btn-primary"><?php echo get_languageword('save');?></button>



                                  <a class="btn btn-warning"
                                      href="<?php echo URL_FAQS_CATEGORIES_INDEX;?>"><?php echo get_languageword('cancel');?></a>
