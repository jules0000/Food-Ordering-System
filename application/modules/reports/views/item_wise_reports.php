            ...
            <div class="panel panel-default">
				...
				?>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <button type="submit" name="item_wise_reports" value="item_wise_reports"
				...
				if(isset($_POST['item_wise_reports']) && isset($profit)) {?>
                            ...
                            <div class="form-group">
                                ...
                                <p class="order-summary">
                                    <strong><?php echo get_languageword('total_orders_amount').'   '.$currency_symbol.$profit->total_orders_amount;?></strong>
                                </p>

                                <p class="order-summary">
                                    <strong><?php echo get_languageword('total_items_amount').'   '.$currency_symbol.$profit->total_items_amount;?></strong>
                                </p>
