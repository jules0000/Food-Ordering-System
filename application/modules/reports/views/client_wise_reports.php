        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
				...
				?>
                            ...
                            <div class="form-group col-md-3">
                                <button type="submit" name="client_wise_reports" value="client_wise_reports"
				...
				$i++;?>
                                <tr>
                                    ...
                                    <td><?php if(isset($r->payment_type)) echo $r->payment_type;if(!empty($r->payment_gateway)) echo ' - '.$r->payment_gateway;?>
                                    </td>
