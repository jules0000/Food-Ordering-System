              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_FAQS_INDEX; ?>"><i class="fa fa-list"></i>
                      </a>
                  </div>
                  <div class="panel-body">
                      ...
                      <div class="row">
						...
						echo form_open(URL_ADDEDIT_FAQ,$attributes);?>
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <?php						$val='';						if(isset($record) && !empty($record))						{							$val = $record->fc_id;						}						else if(isset($_POST))						{							$val = set_value('category');						}																		echo form_dropdown('category',$categories,$val,'class="chzn-select form-control"').form_error('category');						?>
                              </div>
                              <div class="form-group">
						...
						echo form_hidden('id',$value);?>
                                  ...
                                  <button type="submit" name="addedit_faq" value="addedit_faq"
                                      class="btn btn-primary"><?php echo get_languageword('save');?></button>

                                  <a class="btn btn-warning"
                                      href="<?php echo URL_FAQS_INDEX;?>"><?php echo get_languageword('cancel');?></a>
                              </div>
    ...
    $('#faq_from').bootstrapValidator({
        ...
        fields: {
            category: {
                validators: {
                    notEmpty: {
                        message: '<?php echo get_languageword('category_required');?>'
                    }
                }
            },
            question: {
