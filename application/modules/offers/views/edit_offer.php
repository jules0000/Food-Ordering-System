                  ...
                  <div class="panel-body">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-12">
                              ...
                              <div class="col-md-3">
                                  <div class="form-group">
                                      ...
                                      <?php echo form_dropdown('item_name',$categories,set_select('item_name'),'class="chzn-select" id="item_namae" onchange="get_items(this.value)"');?>
                              ...
                              <div class="col-md-3">
                                  <input type="hidden" name="product_count" id="product_count"
                                      value="<?php echo $record->no_of_products+1;?>">
							 ...
							 ?>
                                      <tr>
                                          <td><?php echo $i; ?></td>
                                          <td><input type="text" readonly name="<?php echo "menu".$i?>"
                                                  id="<?php echo "menu".$i ?>"
                                                  value="<?php echo $offerProduct->menu_name; ?>"
                                                  class="form-control"><input type="hidden"
                                                  name="<?php echo "menu_id".$i ?>" id="<?php echo "menu_id".$i ?>"
                                                  value="<?php echo $offerProduct->menu_id;?>"></td>
                                          <td><input type="text" readonly name="<?php echo "item_name".$i ?>"
                                                  id="<?php echo "item_name".$i ?>"
                                                  value="<?php echo $offerProduct->item_name; ?>"
                                                  class="form-control"><input type="hidden"
                                                  name="<?php echo "item_id".$i ?>" id="<?php echo "item_id".$i ?>"
                                                  value="<?php echo $offerProduct->item_id; ?>"></td>
                                          <td><input type="text" name="<?php echo "quantity".$i ?>"
                                                  id="<?php echo "quantity".$i ?>"
                                                  value="<?php echo $offerProduct->quantity;?>" class="form-control">
                                          </td>
                                          <?php $i++;?>
                                      </tr>
                                      <?php endforeach; } ?>
						...
						echo form_hidden('offer_id',$record->offer_id);
                                  ...
                                  <button type="submit" name="update_offer" value="update_offer"
