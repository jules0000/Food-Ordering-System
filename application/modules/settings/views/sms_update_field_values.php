          ...
          <div class="col-md-12">
              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      <?php if(isset($pagetitle)) echo $pagetitle;?> <a
                          title="<?php echo get_languageword('go_to_list'); ?>"
                          class="btn btn-primary btn-xs pull-right" href="<?php echo URL_SMS_GATEWAYS;?>"><i
                     ...
                     if($row->is_required == 'No') {
						...
						?>
                              ...
                              <div class="form-group pull-right">
                                  <button type="submit" name="update_sms_gateway" value="update_sms_gateway"
                                      class="btn btn-primary"><?php echo get_languageword('update');?></button>

                                  <a class="btn btn-warning"
                                      href="<?php echo URL_SMS_GATEWAYS;?>"><?php echo get_languageword('cancel');?></a>
                              </div>
