      ...
      <div class="row">
		...
		echo form_input($element).form_error('facebook_app_secret');?>
					...
					?>
                              ...
                              <div class="form-group">
                                  <label><?php echo get_languageword('contact_email').required_symbol();?></label>
                                  <?php										$val='';										if(isset($record) && !empty($record))										{											$val = $record->portal_email;										}										else if(isset($_POST))										{											$val = set_value('portal_email');										}																				$element = array('name'=>'portal_email',										'value'=>$val,										'class'=>'form-control',										'type'=>'email');										echo form_input($element).form_error('portal_email');										?>
                              </div>
                              ...
                              <div class="form-group">
                                  <label><?php echo get_languageword('contact_map').required_symbol();?> <a
                                          href="https://www.embedgooglemap.net/" target="_blank"
                                          title="Generate script here">Generate script here</a> </label>
                                  <?php
										$val='';
										if(isset($record) && !empty($record))
										{
                          ...
                          <div class="col-md-6">
									...
									if(isset($record) && $record->sms_notifications=='Yes')
									{
                                      ...
                                      <div class="digiCrud">
                                          <div class="slideThree slideBlue">
                                              <input type="checkbox" class="crunch-vanish" id="sms_notifications"
                                                  name="sms_notifications" <?php echo $checked; ?> />
                              ...
                              <div class="col-md-12 crunchy-design">
                                  <label><?php echo get_languageword('design_by').required_symbol();?></label>
                              </div>
                              <div class="form-group">
                                  <?php
										$val='';
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="file" name="site_logo" title="Primary Site Logo"
                                      onchange="photo(this,'site_logoo')">
                                  ...
                                  <?php 
										...
										?>
                                  <img id="site_logoo" src="<?php echo $src;?>" style="<?php echo $style;?>"
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="file" name="second_site_logo" title="Secondary Site Logo"
                                      onchange="photo(this,'second_site_logoo')">
                                  ...
                                  <?php 
										...
										?>
                                  <img id="second_site_logoo" src="<?php echo $src;?>" style="<?php echo $style;?>"
                                      alt="Secondary Site Logo">
                              </div>



                              <div class="form-group">
                                  <label><?php echo get_languageword('home_page_image').required_symbol();?>(<small><strong><?php echo ALLOWED_TYPES;?></strong>
                                      </small>) <small>(min & max height*width: 1980*448 & 2000*500)</small> </label>
                                  <input type="file" name="home_page_img" title="Home Page Background Image"
                                      onchange="photo(this,'home_page_imge')">
                                  ...
                                  <?php 
										...
										?>
                                  <img id="home_page_imge" src="<?php echo $src;?>" style="<?php echo $style;?>"
                                      alt="Home Page Background Image">
                              </div>


                              <button type="submit" name="site_settings" value="site_settings"
                                  class="btn btn-primary"><?php echo get_languageword('update');?></button>
                              <a class="btn btn-warning"
                                  href="<?php echo URL_SITE_SETTINGS;?>"><?php echo get_languageword('cancel');?></a>
