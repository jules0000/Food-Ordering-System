                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="form-group pull-right">
                                  ...
                                  <button type="submit" name="pusher_notification_settings"
                                      value="pusher_notification_settings"
                                      class="btn btn-primary"><?php echo get_languageword('update');?></button>

                                  <a class="btn btn-warning"
                                      href="<?php echo URL_PUSHER_NOTIFICATION_SETTINGS;?>"><?php echo get_languageword('cancel');?></a>
