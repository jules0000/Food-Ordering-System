              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_SMS_TEMPLATES;?>"><i class="fa fa-list"></i>
                      </a>
                      ...
                      <div class="row">
						...
						?>
                              ...
                              <div class="form-group pull-right">
                                  ...
                                  <button type="submit" name="update_sms_template" value="update_sms_template"
                                      class="btn btn-primary"><?php echo get_languageword('update');?></button>



                                  <a class="btn btn-warning"
                                      href="<?php echo URL_SMS_TEMPLATES;?>"><?php echo get_languageword('cancel');?></a>
