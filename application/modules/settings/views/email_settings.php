                     ...
                     <div class="row">
                                 ...
                                 <div class="radio">
                                     ...
                                     <label> <?php echo get_languageword('web_mail').required_symbol();?>
                                         ...
                                         <input type="radio" name="mail_config" value="webmail"
                                             <?php if (isset($record->mail_config) && $record->mail_config == 'webmail') echo 'checked="checked" '; ?>>
                         ...
                         <div class="col-md-6">
                                 ...
                                 <div class="radio">
                                     ...
                                     <label> <?php echo get_languageword('mandrill').required_symbol();?>
                                         ...
                                         <input type="radio" name="mail_config" value="mandrill"
                                             <?php if (isset($record->mail_config) && $record->mail_config == 'mandrill') echo 'checked="checked" ';?>>
                             ...
                             <div class="form-group">
                                 ...
                                 <button type="submit" name="email_settings" value="email_settings"
                                     class="btn btn-primary"><?php echo get_languageword('update');?></button>

                                 <a class="btn btn-warning"
                                     href="<?php echo URL_EMAIL_SETTINGS;?>"><?php echo get_languageword('cancel');?></a>
