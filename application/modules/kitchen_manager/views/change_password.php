						...
						echo form_open(URL_KM_CHANGE_PASSWORD,$attributes);?>
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="form-group pull-right">
                                  ...
                                  <button type="submit" name="change_pwd" value="change_pwd"
                                      class="btn btn-primary"><?php echo get_languageword('change');?></button>



                                  <a class="btn btn-warning"
                                      href="<?php echo URL_KM_CHANGE_PASSWORD;?>"><?php echo get_languageword('cancel');?></a>
