              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_ADDONS_INDEX;?>"><i class="fa fa-list"></i>
                      </a>
                  </div>
                      ...
                      <div class="row">
						...
						?>
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="file" name="addon_image" title="Addon Image"
                                      onchange="photo(this,'addon_image')">
						...
						echo form_hidden('addon_id',$value);?>
                                  ...
                                  <button type="submit" name="addedit_addon" value="addedit_addon"
                                      class="btn btn-primary"><?php echo get_languageword('save');?></button>

                                  <a class="btn btn-warning"
                                      href="<?php echo URL_ADDONS_INDEX;?>"><?php echo get_languageword('cancel');?></a>
                              </div>
