              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_DELIVERY_LOCATIONS; ?>"><i class="fa fa-list"></i>
                      </a>
                  </div>
                  <div class="panel-body">
                      ...
                      <div class="row">
						...
						?>
                              ...
                              <div class="form-group">
                                  <label><?php echo get_languageword('delivery_time_units').required_symbol();?></label>
                                  <?php						$options=array(						'minutes'=>get_languageword('minutes'),						'hours'=>get_languageword('hours'));						$val='';						if(isset($record) && !empty($record))						{							$val = $record->delivery_time_units;						}						else if(isset($_POST))						{							$val = set_value('delivery_time_units');						}						echo form_dropdown('delivery_time_units',$options,$val,'class="chzn-select form-control"').form_error('delivery_time_units');						?>
                              </div>
                              <div class="form-group">
						...
						echo form_hidden('service_provide_location_id',$value);?>
                                  ...
                                  <button type="submit" name="addedit_location" value="addedit_location"
                                      class="btn btn-primary"><?php echo get_languageword('save');?></button>

                                  <a class="btn btn-warning"
                                      href="<?php echo URL_DELIVERY_LOCATIONS;?>"><?php echo get_languageword('cancel');?></a>
                              </div>
