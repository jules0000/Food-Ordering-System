                      ...
                      <div class="row">
						...
						?>
                                  <div class="digiCrud">
                                      <div class="slideThree slideBlue">
                                          <input type="checkbox" class="crunch-vanish" id="referral_enabled"
                                              name="referral_enabled" <?php echo $checked;?> />
						...
						?>
                              ...
                              <div class="form-group pull-right">
                                  <button type="submit" name="update_referral" value="update_referral"
