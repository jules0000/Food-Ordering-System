                      ...
                      <div class="row">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="digiCrud">
                                      <div class="slideThree slideBlue">
                                          <input type="checkbox" class="crunch-vanish" id="enable_redeeming"
                                              name="enable_redeeming" <?php echo $checked;?> />
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="digiCrud">
                                      <div class="slideThree slideBlue">
                                          <input type="checkbox" class="crunch-vanish" id="points_enabled"
                                              name="points_enabled" <?php echo $checked;?> />
                              ...
                              <div class="form-group pull-right">
                                  ...
                                  <button type="submit" name="point_settings" value="point_settings"
                                      class="btn btn-primary"><?php echo get_languageword('update');?></button>
                                  <a class="btn btn-warning"
                                      href="<?php echo URL_POINTS_SETTINGS;?>"><?php echo get_languageword('cancel');?></a>
        ...
        fields: {
            ...
            earning_point_value: {
                validators: {
                    ...
                    regexp: {
                        regexp: /(?:\d*\.)?\d+/,
                        message: '<?php echo get_languageword('please_enter_valid_value');?>'
                    }
                }
            },
            redeeming_point: {
