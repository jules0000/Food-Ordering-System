    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <div class="cs-card cart-card card-show">
                <div class="card-header bordered clearfix"><span
                        class="stat-count">2</span><?php echo get_languageword('delivery_details');?> <button
                        type="button" data-toggle="modal" data-target="#address-modal"
                        class="btn btn-outline-primary pull-right"><i class="pe-7s-plus"></i>
                        <?php echo get_languageword('add_new_address');?></button></div>
					...
					if(!empty($user_addresses)) {
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="pb-delivery-address" onclick="check_address('<?php echo $address->ua_id;?>');">
                                ...
                                <input id="address<?php echo $k;?>" class="pb-radio-custom pb-radio-address"
                                    name="zipcode" type="radio" value="<?php echo $address->ua_id;?>"
                                    <?php echo $checked;?>>

                                <label for="address<?php echo $k;?>"
                                    class="pb-radio-custom-label pb-radio-address-label">
                                    <?php echo get_languageword('deliver_to_this_address');?> </label>
            ...
            <div class="cs-card cart-card mt-2 payment-card-hide">
                <div class="card-header bordered"><span
                        class="stat-count">3</span><?php echo get_languageword('redeem_points');?></div>
                        ...
                        <div class="col-lg-6 col-md-7 col-sm-12">
                            <div class="pb-delivery-address pb-radeem-points">
                                <div class="address">
                                    ...
                                    <div class="points-radeem"> <i class="pe pe-7s-wallet"></i>
                                        <b><?php echo $redeem_points[2];?> <?php echo get_languageword('points');?> </b>
                                    </div>
                                ...
                                <input id="user_points" class="pb-radio-custom pb-radio-address"
                                    name="user_redeem_points" type="checkbox" value="<?php echo $redeem_points[0];?>"
                                    onclick="check_points();">

                                <label for="user_points" class="pb-radio-custom-label pb-radio-address-label">
                                    <?php echo get_languageword('redeem');?> </label>
            ...
            <div class="cs-card cart-card mt-2 payment-card-hide">
                <div class="card-header bordered"><span
                        class="stat-count"><?php echo $pay_no; ?></span><?php echo get_languageword('payment'); ?></div>
                <div class="cs-card-content card-items-list">
                    <div class="row">
                        <?php 
            ...
            ?>
                        ...
                        <div class="col-md-5 col-sm-12" onclick="show_cards()">
                            <div class="pb-radio-netbanking">
                                <input id="online" class="pb-radiobox-popular pb-radio-address" name="payment_type"
                                    type="radio" value="online">
                                <label for="online" class="pb-radiobox-popular-label pb-radio-address-label"> &nbsp;
                                    <img src="<?php echo FRONT_IMAGES; ?>p-paypal.png" alt="Paypal"
                                        class="pb-netbanking-icons" title="Paypal">
                                </label>
                            </div>
                        </div>
                        <?php } ?>

                        <?php if (in_array('cash_on_delivery', $admn_prvd_paymnts)) { ?>
                        <div class="row">
                            <div class="col-md-5 col-sm-12" onclick="show_cards()">
                                <div class="pb-radio-netbanking">
                                    <input id="cash" class="pb-radiobox-popular pb-radio-address" name="payment_type"
                                        type="radio" value="cash">
                                    <label for="cash" class="pb-radiobox-popular-label pb-radio-address-label"> &nbsp;
                                        <?php echo get_languageword('cash_on_delivery'); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-sm-12">
                                <div class="pb-radio-netbanking" onclick="show_cards()">
                                    <input id="cashCard" class="pb-radiobox-popular pb-radio-address"
                                        name="payment_type" type="radio" value="cashCard">
                                    <label for="cashCard" class="pb-radiobox-popular-label pb-radio-address-label">
                                        &nbsp;
                                        <?php echo get_languageword('card_on_delivery'); ?>
                                    </label>
                                </div>
                                ...
                                <li class="dm-noborder dm-itemcards" style="display:none;">
                                    ...
                                    <div class="dm-cardtype">
                                        <label>
                                            <input type="radio" name="payment_card"
                                                value="<?php echo $value->alt_text; ?>"
                                                id="<?php echo $value->card_image_id; ?>"
                                    ...
                                    ?>
                                            <img class="pb-netbanking-icons" src="<?php echo $img_src; ?>"
                                                alt="<?php echo $value->alt_text; ?>">
                                        </label>
                                    </div>
                                    <?php } ?>
                                </li>
                        ...
                        <?php } else { ?>
                        <h4><?php echo get_languageword('no_payment_methods_available'); ?></h4>
                        <?php } ?>
            ...
            <div class="col-sm-3" id="item-sidebar">
                <div class="cs-card card-y-auto cart-card ml-lg-2 item-sidebar">
                    ...
                    <button type="submit" name="submit_type" value="save_order"
                        class="btn btn-primary btn-block btn-checkout" id="book_order">
                        <?php echo get_languageword('continue'); ?>
                    </button>
                </div>
            </div>
        </div>
