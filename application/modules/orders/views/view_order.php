              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_ORDERS_INDEX.$order->status;?>"><i class="fa fa-list"></i>
                      </a>
                  </div>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          ...
                                          <a data-toggle="modal" data-target="#deleteModal"
                                              title="<?php echo get_languageword('delete');?>"
                                              class="<?php echo CLASS_DELETE_BTN;?>"
                                              onclick="delete_item('<?php echo $product->order_id;?>','<?php echo $product->op_id;?>','product')"><i
                                                  class="<?php echo CLASS_ICON_DELETE;?>"></i></a>
                                          <?php } ?>
                                      </td>
                                      <?php } ?>
                      ...
                      <div class="table-responsive table1">
                          <table cellspacing="10" width="100%" id="example" class="display responsive nowrap"
                              ...
                              <thead>
                                  <tr>
                                      ...
                                      <th><?php echo get_languageword('total_cost');?></th>
                                      <th><?php echo get_languageword('is_deleted');?></th>
                                      <?php if($order->status =='new' || $order->status =='process') { ?>
						...
						$i++;?>
                                  <tr>
                                      ...
                                      </td> <?php if($order->status =='new' || $order->status =='process') { ?>
                                      <td>
                                          <?php if($addon->is_deleted==0) { ?>
                                          <a data-toggle="modal" data-target="#deleteModal"
                                              title="<?php echo get_languageword('delete');?>"
                                              class="<?php echo CLASS_DELETE_BTN;?>"
                                              onclick="delete_item('<?php echo $addon->order_id;?>','<?php echo $addon->oa_id;?>','addon')"><i
                                                  class="<?php echo CLASS_ICON_DELETE;?>"></i></a>
                                          <?php } ?>
                                      </td>
                                      <?php } ?>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          ...
                                          <a data-toggle="modal" data-target="#deleteModal"
                                              title="<?php echo get_languageword('delete');?>"
                                              class="<?php echo CLASS_DELETE_BTN;?>"
                                              onclick="delete_item('<?php echo $offer->order_id;?>','<?php echo $offer->order_offer_id;?>','offer')"><i
                                                  class="<?php echo CLASS_ICON_DELETE;?>"></i></a>
                                          <?php } ?>
                                      </td>
                                      <?php } ?>
          ...
          <div class="modal-content order-content">
              ...
              <div class="order-modal-footer modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary"
                      name="delete_item"><?php echo get_languageword('yes');?></button>
