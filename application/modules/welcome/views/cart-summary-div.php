            ...
            <li class="clearfix">
                <div class="list-left">
                    ...
                    <div class="cart-item-cutomize mt-08">
                        <a href="javascript:void(0);" class="btn-cutomize"
                            onclick="get_item_popup('<?php echo $items['id'];?>')"><?php echo get_languageword('view');?></a>
                    </div>
    ...
    <div class="cs-card-content">
        <ul class="list-left-right cart-total-details">
            ...
            <li class="clearfix">
                ...
                <div class="list-right"><?php echo $currency_symbol;?><span
                        id="delivery_fee"><?php echo $deliverfee;?></span> </div>
            </li>
        ...
        <ul class="list-left-right">
            <li class="clearfix">
                ...
                <div class="list-right"><strong
                        class="text-success"><?php echo $currency_symbol;?><?php echo $total_pay;?></strong></div>
            </li>
        </ul>
