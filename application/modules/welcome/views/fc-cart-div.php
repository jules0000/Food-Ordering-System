<div>
            ...
            <li class="clearfix">
                <div class="list-left">
                    ...
                    <div class="cart-item-cutomize mt-08">
                        <a href="javascript:void(0);" class="btn-cutomize" href="javascript:void(0);"
                            onclick="get_cart_itm_adns_options('<?php echo $items['id'];?>')"><?php echo get_languageword('customize');?></a>
                    </div>

                    <?php } else if ($items['options']['is_offer'] == 1) { ?>

                    <div class="cart-item-cutomize mt-08">
                        <a href="javascript:void(0);" onclick="get_offer_popup('<?php echo $items['id'];?>','cart')"
                            class="btn-cutomize"><?php echo get_languageword('view');?></a>
                    </div>
                ...
                <div class="list-right">
                    <div class="card-item-price"><?php echo $currency_symbol;?><span><?php echo $itm_total;?></span>
                    </div>

                    <div class="card-item-actions mt-08">
                        <i class="pe-7s-less"
                            onclick="update_qty('<?php echo $items['rowid'];?>','decr')"></i><span><?php echo $items['qty'];?></span><i
                            class="pe-7s-plus" onclick="update_qty('<?php echo $items['rowid'];?>','incr')"></i>
                    </div>
    ...
    <?php } else { ?>
    <div class="p-20">
        <h5><?php echo get_languageword('no_items_in_your_cart');?></h5>
    </div>
    <?php } ?>
