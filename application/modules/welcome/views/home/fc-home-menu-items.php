        ...
        <div class="cs-card-content clearfix">
            ...
            <div class="pull-right">
                ...
                <a href="javascript:void(0);" onclick="get_adns_options('<?php echo $item->item_id;?>')"
                    class="btn btn-sm btn-round btn-primary card-btn"><?php echo get_languageword('choose');?> <i
...
<div class="row">
    <div class="col-sm-12">
        <div class="text-center">
            <a href="<?php echo URL_MENU;?>" class="btn btn-load-more"><?php echo get_languageword('view_more');?></a>
