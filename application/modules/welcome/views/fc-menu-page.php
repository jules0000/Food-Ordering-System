    ...
    <div class="row">
        <div class="col-sm-3 hidden-xs">
            <div class="left-sidebox">
                <div class="search cs-searchbox mb-2">
                    <div class="search-innerwrapper">
                        ...
                        <input type="text" id="search-inp" name="search-inp"
                            placeholder="<?php echo get_languageword('search');?>" onkeyup="search_item();"><i
			...
			?>
                    ...
                    <a href="javascript:void(0);" class="list-group-item <?php echo $clas;?>"
                        onclick="get_menu_items_block('<?php echo $menu->menu_id;?>','<?php echo $menu->menu_name;?>')"
                        id="<?php echo $menu->menu_id;?>"><?php echo $menu->menu_name;?></a>

                    <?php } } ?>



                    <a href="javascript:void(0);" class="list-group-item" onclick="get_offers_block()"
                        id="offers"><?php echo get_languageword('offers');?></a>

                    <a href="javascript:void(0);" class="list-group-item" onclick="get_popular_items_block()"
                        id="popular_items"><?php echo get_languageword('popular_items');?></a>
        ...
        <div class="col-sm-3" id="item-sidebar">
            <div class="cs-card cart-card card-y-auto ml-lg-2 item-sidebar">
                ...
                <div class="checkout-btn">
                    <a href="<?php echo URL_CART_INDEX;?>" class="btn btn-primary btn-block btn-checkout">
                        <?php echo get_languageword('checkout');?> </a>
                </div>
...
function get_more_popular_items() {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: '<?php echo $this->security->get_csrf_token_name();?>=<?php echo $this->security->get_csrf_hash();?>&offset=' +
            offset,
        success: function(response) {
...
function search_item() {
    ...
    if (search_strng != '') {
        $.ajax({
            ...
            type: 'POST',
            data: '<?php echo $this->security->get_csrf_token_name();?>=<?php echo $this->security->get_csrf_hash();?>&strng=' +
                search_strng,
            success: function(response) {
