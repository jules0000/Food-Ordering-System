              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                      ...
                      <a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right"
                          href="<?php echo URL_ITEMS_INDEX; ?>"><i class="fa fa-list"></i>
                      </a>
                  </div>
                      ...
                      <div class="row">
                          ...
                          <ul class="nav nav-tabs" role="tablist">
                              <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                      data-toggle="tab"><?php echo get_languageword('item_details');?></a></li>

                              <li role="presentation"><a href="#options" aria-controls="options" role="tab"
                                      data-toggle="tab"><?php echo get_languageword('options');?></a></li>
                          </ul>
                          <!-- Nav tabs -->
						...
						?>
                                      ...
                                      <div class="form-group">
                                          <label><?php echo get_languageword('item_image').required_symbol();?>(<small><strong><?php echo ALLOWED_TYPES;?></strong></small>)
                                              <br> <small>For better resolution min & max width*height : 263*180 &
                                                  526*360 </small> </label>
                                          <input type="file" name="item_image" title="Item Image"
                                              onchange="photo(this,'item_image')">
						...
						echo form_hidden('item_id',$value);?>
                                          ...
                                          <button type="submit" name="edit_item_save" value="edit_item_save"
                                              class="btn btn-primary"><?php echo get_languageword('save');?></button>

                                          <a class="btn btn-warning"
                                              href="<?php echo URL_ITEMS_INDEX;?>"><?php echo get_languageword('cancel');?></a>
                                      </div>
                              ...
                              <div role="tabpanel" class="tab-pane" id="options">
                                  ...
                                  <div class="col-md-12">
                                      ...
                                      <div class="col-md-4">
                                          <div class="form-group">
                                              <label><?php echo get_languageword('options');?><span
                                      ...
                                      <div class="col-md-4">
                                          ...
                                          <label><?php echo get_languageword('price');?><span
                                                  style="color:red;">*</span></label>
                                      ...
                                      <div class="col-md-4">
                                          ...
                                          <input type="button" name="reset" class="btn btn-primary"
                                              onclick="AddOptionRow();" value="+">

                                          <input type="button" name="add" class="btn btn-warning"
                                              onclick="removeOptionRow();" value="-">
                                      </div>
				  ...
				  echo form_open(URL_EDIT_ITEM,$attributes); ?>
                                      ...
                                      <input type="hidden" name="option_count" id="option_count"
                                          value="<?php if(isset($item_selected_options) && count($item_selected_options)>0) echo count($item_selected_options)+1; else echo "1";?>">

                                      <input type="hidden" name="option_counts" id="option_counts">

                                      <input type="hidden" name="item_id"
                                          value="<?php if(isset($record)) echo $record->item_id;?>">
					  ...
					  ?>
                                              <tr>
                                                  ...
                                                  <td>
                                                      ...
                                                      <input type="text" readonly name="option_name<?php echo $i; ?>"
                                                          id="option_name<?php echo $i; ?>"
                                                          value="<?php echo $item_option->option_name;?>"
                                                          class="form-control">
                                                  ...
                                                  <td>
                                                      ...
                                                      <input type="hidden"
                                                          value="<?php echo $item_option->option_id; ?>"
                                                          name="option_id<?php echo $i;?>"
                                                          id="option_id<?php echo $i;?>">

                                                      <input type="text" value="<?php echo $item_option->price;?>"
                                                          name="price<?php echo $i; ?>"
                                                          id="price<?php echo $i; $i++; ?>" class="form-control">
                                      ...
                                      <div class="form-group pull-right">
                                          <button type="submit" name="item_options_save"
                                              class="btn btn-primary"><?php echo get_languageword('add');?></button>
                                      </div>
	 ...
	 if(isset($item_selected_options) && !empty($item_selected_options)){
      ...
      function AddOptionRow() {
          ...
          if ($('#option_name').val() == "") {
              ...
              $('#first tr').last().after('<tr><th scope="row">' + sno +
                  '</th><td><input type="text" readonly name="option_name' + ncnt + '" id="option_name' + ncnt +
                  '" value="' + $('#option_name option:selected').text() +
                  '" class="form-control"></td><td><input type="hidden" readonly value="' + $(
                      '#option_name option:selected').val() + '" name="option_id' + ncnt + '" id="option_id' +
                  ncnt + '"><input  type="text" value="' + $('#price').val() + '" name="price' + ncnt +
                  '" id="price' + ncnt + '" class="form-control"></td></tr>');
      ...
      <?php } ?><script type="text/javascript" src="<?php echo JS_ADMIN_BOOTSTRAP_MAXLENGTH_MIN;?>"></script>
      <script type="text/javascript">
      $('textarea').maxlength({
          alwaysShow: true,
          threshold: 10,
