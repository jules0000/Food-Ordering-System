    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="cs-card cart-card card-show">
                <div class="card-header bordered card-header-lg"><?php if (isset($pagetitle)) echo $pagetitle;?> <a
                        class="btn btn-outline-primary pull-right" data-toggle="modal"
                        data-target="#add-address-modal"><i class="pe-7s-plus"></i>
                        <?php echo get_languageword('add_new_address');?></a></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="pb-saved-address">
                                ...
                                <span class="default-address"><i class="pe-7s-check"></i>
                                    <?php echo get_languageword('default');?></span>
                                <?php } ?>
                                ...
                                <ul class="pw-address-actions">
                                    ...
                                    <li><a data-toggle="modal" data-target="#address-delete-modal"
                                            onclick="delete_address('<?php echo $address->ua_id;?>')"><i
                                                class="pe-7s-trash"></i></a></li>

                                    <?php if($address->is_default!='Yes') {?>

                                    <li><a data-toggle="modal" data-target="#default-address-modal"
                                            onclick="default_address('<?php echo $address->ua_id;?>')"><i
                                                class="pe-7s-check"></i></a></li>
                ...
                <div class="login-block">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" name="delete_address"
                            class="btn btn-primary"><b><?php echo get_languageword('yes');?></b></button>
            ...
            <div class="modal-body">
                <div class="login-block">
                    ...
                    <div class="form-group">
                        ...
                        <p><?php echo get_languageword('are_you_sure_to_set_this_address_as_your_default_address?');?>
                        </p>
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" name="default_address"
                            class="btn btn-primary"><b><?php echo get_languageword('yes');?></b></button>
