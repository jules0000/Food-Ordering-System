<div class="container pt-8 pb-8">
    <div class="row">
        <div class="col-md-3">
            ...
            <ul class="dash-menu">
                <li class="active"><a href="<?php echo URL_USER_PROFILE;?>"><i
		 ...
		 $style="display:none;";?>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="profile_image" class="form-control" placeholder="Profile Image"
                        onchange="photo(this,'profile_image')" required />
                    <img id="profile_image" src="<?php echo $src;?>" style="<?php echo $style;?>" class="img-responsive"
                        alt="User Photo" width="80">
                </div>

                <div class="text-right">
                    <button type="submit" name="profile_image"
                        class="btn btn-warning crunch-newaddr"><?php echo get_languageword('save');?></button>
                </div>
                <?php echo form_close();?>
