                      ...
                      <div class="row">
						...
						?>
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="file" name="user_image" title="Profile Image"
                                      onchange="photo(this,'user_image')">
							...
							?>
                              ...
                              <div class="form-group pull-right">
                                  ...
                                  <button type="submit" name="update_profile" value="update_profile"
                                      class="btn btn-primary"><?php echo get_languageword('update');?></button>



                                  <a class="btn btn-warning"
                                      href="<?php echo URL_DM_PROFILE;?>"><?php echo get_languageword('cancel');?></a>
